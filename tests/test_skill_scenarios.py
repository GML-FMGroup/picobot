...
from picobot.skills import read_skill
from picobot.tools import read_file, web_fetch, write_file
...
class ScenarioTests(unittest.TestCase):
    ...
    def test_saas_ui_page_generation(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            os.environ["PICOBOT_WORKSPACE"] = tmp
...
"""
    ...
    def test_weihai_weather_fetch(self) -> None:
        ...
        with patch("picobot.tools.urlopen", return_value=_FakeResponse()):
            data = json.loads(
                web_fetch(
