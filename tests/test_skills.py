"""Tests for picobot skills behavior."""
...
from picobot.skills import SkillRegistry, list_skills, read_skill
...
class SkillRegistryTests(unittest.TestCase):
    ...
    def test_discovers_builtin_skill(self) -> None:
        registry = SkillRegistry(workspace=Path("/tmp/nonexistent-picobot-workspace"))
    ...
    def test_discovers_workspace_skills_via_env(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            os.environ["PICOBOT_WORKSPACE"] = str(workspace)
    ...
    def test_discovers_skills_via_builtin_override_env(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            os.environ["PICOBOT_WORKSPACE"] = "/tmp/nonexistent-picobot-workspace"
            os.environ["PICOBOT_BUILTIN_SKILLS_DIR"] = str(builtin_dir)
